...
public class Player : MonoBehaviour {
    ...
    void handleMove()
    {
        ...
        // Modificar la direcci�n para que ignore la componente y
        forward.y = 0f;
        forward.Normalize();

        // Multiplicar la direcci�n hacia adelante por la entrada vertical
        Vector3 moveDirection = forward * inputZ;

        // Ajustar la velocidad seg�n el factor de caminar/correr
